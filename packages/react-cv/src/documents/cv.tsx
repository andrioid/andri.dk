...
import type { Basic, Profile, Resume, Skill } from "../components/resume-types";
        ...
        >
          <View style={styles.left}>
            ...
            <Section title="Skills" iconName="skills">
              <Text style={{ color: "grey", fontSize: 7, marginTop: -10 }}>
              ...
              {skills?.map((s) => (
                <View key={s.name} wrap={true} style={{ marginTop: 10 }}>
                  <Text
                    style={{
                      fontWeight: "bold",
                      color: s.id !== undefined ? colors[s.id] : "black",
                    }}
                    key={s.name}
                  >
                    {s.name}
