// Borrowed from: https://github.com/Minivera/react-vitae/blob/main/packages/react-vitae/src/types.ts (MIT licensed)
...
export interface Work {
	...
	// Keywords or skills, e.g. React, JavaScript
	keywords?: string[];
}

// e.g. { name: "Facebook", keywords: ["React"] }
export type WorkWithKeywords = Work & {};
